...
<div class="row-fluid sortable">
  <div class="box span12">
    ...
    <div class="box-content">
      <div class="box-content">
	      <?=$msg?>
        <form class="form-horizontal" id="season_add_form" method="post" action="index.php">
        ...
        <input type="hidden" name="pk_id" id="pk_id" value="<?=$_REQUEST['id']?>" />
          ...
          <div class="control-group">
              ...
              <div class="controls">
                <input type="text" required value="" id="data_season_title" name="data_season_title" class="input-xsmall focused">
		...
		<div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls"><?=$objHTML->statusBasicCombo('data_season_status',"","required")?></div>
            </div>
...
$('#data_season_title').on('change', function(){
		...
		$.ajax({
			type	: "GET",
			url		: "ajax.php",
			data    : "ajaxcall=true&mod=checkUniqRecord&act=ADD&tb=season&col_name=season_title&col_value="+$("#data_season_title").val(),

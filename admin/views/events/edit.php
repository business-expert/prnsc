        ...
        <form class="form-horizontal" method="post" action="index.php" enctype="multipart/form-data">
          ...
          <fieldset>
            <div class="control-group">
              ...
              <div class="controls"> <span class="input-xlarge uneditable-input" style="width:210px">
                <?=$datum->id?></span> </div>
            </div>
            <div class="control-group">
              <label class="control-label" for="data_name"> Event Title </label>
              <div class="controls">
                <input type="text" required value="<?=$datum->name?>" id="data_name" name="data_name" class="input-xsmall focused">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label" for="data_season">Event Season </label>
              <div class="controls">
			  <?=$objHTML->seasonBasicCombo("data_season",$datum->season, "required");?>
              </div>
            </div>
		...
		<div class="control-group">
			...
			<div class="control-group">
              ...
              <div class="controls">
				...
				<br />
				<img src="<?=FILE_VIEW_PATH?>/<?=$datum->event_image?>" class="img100" />
			  </div>
            </div>
            ...
            <div class="control-group">
              <label class="control-label" for="data_active">Active Status </label>
              <div class="controls">
			  <?=$objHTML->activeBasicCombo("data_active",$datum->active, "required");?>

...
<div>
 <ul class="breadcrumb">
       <li><a href="index.php?model=race">Race</a> <span class="divider">/</span></li>
        <li><a href="#">Update Race</a></li>
   </ul>
</div>
<div class="row-fluid sortable">
  <div class="box span12">
    <div class="box-header well" data-original-title>
      <h2><i class="icon-user"></i>Update Race</h2>
      ...
      <div class="box-content">
        ...
        <input type="hidden" name="pk_id" id="pk_id" value="<?=$_REQUEST['id']?>" />
          <fieldset>
            <div class="control-group">
              ...
              <div class="controls">
				<?=$objHTML->raceTypeCombo('data_race_type',$datum->race_type,"required", "Select Race Type")?> 
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
				<?=$objHTML->eventTypeCombo('data_event_id',$datum->event_id,"required","Select Event")?>
		...
		<div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls"><?=$objHTML->statusBasicCombo('data_race_active',$datum->race_active,"required")?></div>
            </div>

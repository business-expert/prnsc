...
<div class="row-fluid sortable">
  <div class="box span12">
    <div class="box-header well" data-original-title>
      <h2><i class="icon-user"></i>Add Admin</h2>
        ...
        <input type="hidden" name="pk_id" id="pk_id" value="<?=$_REQUEST['id']?>" />
          ...
          <div class="control-group">
			...
			<div class="control-group">
              ...
              <div class="controls">
                <input type="email" required value="<?=$datum->admin_name?>" id="data_admin_email" name="data_admin_email" class="input-xsmall focused" />
...
$('#data_admin_email').on('change', function(){
    if($('#data_admin_email').val().length > 10)
	{
		$.ajax({
			type	: "GET",
			url		: "ajax.php",
			data    : "ajaxcall=true&mod=checkUniqRecord&act=ADD&tb=admin&col_name=admin_email&col_value="+$("#data_admin_email").val(),
